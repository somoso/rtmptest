...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSArray<NSNumber *> * _Nonnull pixelFormatAttributes;)
+ (NSArray<NSNumber *> * _Nonnull)pixelFormatAttributes SWIFT_WARN_UNUSED_RESULT;
+ (NSOpenGLPixelFormat * _Nonnull)defaultPixelFormat SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, copy) NSString * _Null_unspecified videoGravity;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) NSColor * _Nonnull defaultBackgroundColor;)
+ (NSColor * _Nonnull)defaultBackgroundColor SWIFT_WARN_UNUSED_RESULT;
+ (void)setDefaultBackgroundColor:(NSColor * _Nonnull)value;
...
- (void)attachScreen:(AVCaptureScreenInput * _Nullable)screen;
@end
